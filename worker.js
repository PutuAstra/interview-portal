...
- A 1–2 sentence summary paragraph. Start with the candidate's FULL name and their TOTAL years of experience, e.g. "Angelicia Hikari Maritung is a culinary professional with 3 years of experience in pastry and kitchen operations." Compute the total by ADDING UP the durations of every role in the work history — use stated durations, or the span between each role's start and end dates (use today's date for "Present"/current roles), then sum and round to the nearest whole year. If durations/dates are missing, say "several years of experience" rather than guessing a number. Mention their strongest area(s). Then, if the source states the candidate's age or date of birth, add it as its own short sentence, e.g. "She is currently 28 years old." (NOT an inline aside like "Angelicia, 28, …"); compute age from today's date when only a date of birth is given. If no age/DOB appears, do NOT mention age.
- Then a blank line.
...
- Then a section header line that is EXACTLY "Skills & Certification:" on its own line, followed by 2–4 bullets of key skills, certifications, or languages. For any certification, test, or language qualification, keep its EXACT name and score/level from the source — e.g. write "TOEIC (English) — 800" or "TOEIC English Proficiency", NOT a generic "English Proficiency". Likewise name specific certs verbatim (e.g. ServSafe, HACCP, BNSP) rather than describing them generically.
